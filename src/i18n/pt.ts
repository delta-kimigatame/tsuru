export const translationPt = {
  ...
  top: {
    ...
    changelog: [
      ...
      "2026/05/06\r\n[Adição] Adicionado efeito de forma de onda de áudio ao recurso de criação de vídeo.\r\n[Adição] Adicionada ao recurso de criação de vídeo a função de carregar cartão de letras.\r\n[Adição] Agora é possível ampliar e reduzir a escala de exibição do piano roll no recurso de criação de vídeo.\r\n[Correção] Corrigido um problema em que o tamanho da fonte das notas na tela de pré-visualização do recurso de criação de vídeo estava incorreto.\r\n[Correção] Ajustes de layout.",
    ...
    campaigns: [
      ...
      {
        title: "UTAU Super Festival de Postagem 2026 Primavera",
        about: "Que tal postar seus vídeos de UTAU junto ao Niconico Chokaigi?",
        startDatetime: "18/04/2026",
        endDatetime: "25/04/2026",
        eventTag: "UTAU超投稿祭2026春",
        regulations: [
          "Músicas originais, covers, HANASU, MMD... qualquer vídeo de UTAU é bem-vindo!",
          "NicoNico Shorts também são bem-vindos.",
          "Publique no NicoNico apenas.",
          "Colaborações com outros softwares de síntese também são OK!",
          "Respeite os termos de uso de cada banco de voz.",
        ],
      },
    ...
    linkPages: "Links de paginas",
    linkVideoEditor: "Abrir editor de video",
    invalidFile:
      "O arquivo selecionado não é um arquivo zip. Por favor, selecione um arquivo zip.",
  },
  videoEditor: {
    headerTitle: "Editor de video UTAlet",
    headerBackToMain: "Voltar para o UTAlet principal",
    linkPaperTitle: "Links de paginas",
    linkPaperMutual: "Navegacao cruzada",
    linkBackToMain: "Voltar para o UTAlet principal",
    ...
    topDescription:
      "A edicao de video comeca com o UST obrigatorio. Depois de carregar o UST, carregue o WAV para abrir a tela de edicao.",
    loadUstRequired: "Carregar UST",
    loadWavRequired: "Carregar WAV",
    loadPortraitOptional: "Carregar retrato",
    loadIconOptional: "Carregar icone",
    ustStatusLoaded: "UST: {{name}}",
    ustStatusEmpty: "UST: nao carregado",
    wavStatusLoaded: "WAV: {{name}}",
    wavStatusEmpty: "WAV: nao carregado",
    portraitStatusLoaded: "Retrato: {{name}}",
    portraitStatusEmpty: "Retrato: nao carregado (opcional)",
    iconStatusLoaded: "Icone: {{name}}",
    iconStatusEmpty: "Icone: nao carregado (opcional)",
    iconLoadTitle: "Icone do pianoroll",
    portraitLoadTitle: "Material de retrato",
    syncAdjustTitle: "Ajuste de sincronizacao (offset WAV/UST)",
    wavOffsetMs: "Offset WAV (ms)",
    ustOffsetMs: "Offset UST (ms)",
    resetOffsets: "Redefinir offsets",
    playFirstLyricSegment: "Reproduzir primeiro trecho de letra",
    stopPreview: "Parar pre-escuta",
    previewRangeMs: "Faixa de pre-escuta: {{start}}ms - {{end}}ms",
    previewNoLyrics: "Nenhum primeiro trecho de letra encontrado.",
    previewPlayError: "Falha ao reproduzir pre-escuta: {{error}}",
    clearOptional: "Limpar material",
    openEditor: "Abrir tela de edicao de video",
    backToMaterials: "Voltar para selecao de materiais",
    exporting: "Gerando video...",
    back: "Voltar",
    progressFrames: "{{current}}/{{total}}",
  ...
  editor: {
    ...
    videoExport: {
      ...
      backgroundStyleSection: "Estilo de fundo",
      backgroundStyle: "Padrão",
      backgroundPrimaryColor: "Cor principal",
      backgroundSecondaryColor: "Cor secundária",
      backgroundSecondaryOpacity: "Opacidade da cor secundária",
      backgroundPatternSize: "Tamanho do padrão",
      backgroundPatternGap: "Espaçamento",
      backgroundPatternRotation: "Rotação",
      backgroundNoiseIntensity: "Intensidade do ruído",
      backgroundSeed: "Semente",
      backgroundGradientSection: "Gradiente",
      backgroundGradientEnable: "Gradiente",
      backgroundGradientType: "Tipo",
      backgroundGradientType_lightness: "Luminosidade",
      backgroundGradientType_saturation: "Saturação",
      backgroundGradientType_alpha: "Opacidade",
      backgroundGradientAngle: "Ângulo",
      backgroundGradientStart: "Início",
      backgroundGradientEnd: "Fim",
      backgroundGradientStrength: "Intensidade",
      ...
      backgroundStyle_dots: "Bolinhas",
      backgroundStyle_stars: "Estrelas",
      backgroundStyle_gingham: "Xadrez gingham",
      backgroundStyle_grid: "Grade",
      backgroundStyle_stripes: "Listras",
      backgroundStyle_diagonalStripes: "Listras diagonais",
      backgroundStyle_checkerboard: "Tabuleiro",
      backgroundStyle_diamonds: "Losangos",
      backgroundStyle_crosses: "Cruzes",
      backgroundStyle_brickwork: "Tijolos",
      backgroundStyle_zigzag: "Zigue-zague",
      backgroundStyle_circles: "Círculos",
      backgroundStyle_triangles: "Triângulos",
      backgroundStyle_waves: "Ondas",
      backgroundStyle_starfield: "Céu estrelado",
      backgroundStyle_clouds: "Nuvens",
      backgroundStyle_woodgrain: "Veios de madeira",
      backgroundStyle_paper: "Papel",
      backgroundStyle_concrete: "Concreto",
      backgroundStyle_stucco: "Estuque",
      backgroundStyle_fabric: "Tecido",
      backgroundStyle_leather: "Couro",
      bgSize: "Resolução",
      ...
      bgImageOpacity: "Opacidade da imagem de fundo",
      portraitSection: "Retrato",
      ...
      mainTextSection: "Título",
      subTextSection: "Créditos",
      textFontSize: "Tamanho da fonte",
      textPositionX: "Posição X",
      textPositionY: "Posição Y",
      textDisplayMode: "Momento de exibição",
      textDisplayModeAlways: "Sempre",
      textDisplayModeIntro: "Introdução",
      textDisplayModeOutro: "Final",
      textDecoration: "Decoração do texto",
      textShadow: "Sombra",
      textShadowColor: "Cor da sombra",
      textShadowBlur: "Desfoque da sombra",
      textStroke: "Contorno",
      textStrokeColor: "Cor do contorno",
      textStrokeWidth: "Largura do contorno",
      textBgBar: "Barra de fundo",
      textBgBarColor: "Cor da barra",
      textBgBarOpacity: "Opacidade da barra",
      textColor: "Cor do texto",
      mainTextDefault: "Nome da música",
      subTextDefault: "Compositor / Banco de voz / UST Editor",
      exportPreview: "Pré-visualização da exportação",
      lyricsSection: "Legendas",
      lyricsEnable: "Ativar legendas",
      lyricsGlobalSettings: "Configurações de exibição",
      lyricsFontSize: "Tamanho da fonte",
      lyricsColor: "Cor do texto",
      lyricsPositionY: "Posição vertical",
      lyricsMaxWidth: "Largura máx. (reduz automaticamente)",
      lyricsStart: "Início",
      lyricsEnd: "Fim",
      lyricsMerge: "Unir com próxima",
      lyricsSplit: "Dividir",
      lyricsSplitAt: "Dividir aqui",
      lyricsDecoration: "Decoração de texto",
      lyricsShadow: "Sombra",
      lyricsShadowColor: "Cor da sombra",
      lyricsShadowBlur: "Desfoque da sombra",
      lyricsStroke: "Contorno",
      lyricsStrokeColor: "Cor do contorno",
      lyricsStrokeWidth: "Largura do contorno",
      ...
      lyricsCardMappingHint:
        "Esquerda: cartão de letras  /  Direita: segmento  —  divida ou una segmentos para alinhar",
      lyricsCardWordColumn: "Cartão de letras",
      lyricsCardSegmentColumn: "Segmento",
      lyricsCardOpsColumn: "Ops",
      lyricsCardOrphan: "(sem correspondência)",
      lyricsCardUnassigned: "Palavras não atribuídas:",
      lyricsCardApply: "Aplicar",
      lyricsCardCancel: "Cancelar",
      lyricsCardEncodingConfirm: "Confirmar",
      lyricsCardEncodingCancel: "Cancelar",
      ...
      pianorollFps: "FPS de atualização",
      pianorollFps_30: "30 fps",
      pianorollFps_15: "15 fps",
      pianorollFps_10: "10 fps",
      pianorollFps_5: "5 fps",
      pianorollFps_3: "3 fps",
      pianorollFps_2: "2 fps",
      pianorollFps_1: "1 fps",
      ...
      pianorollShowKeyboard: "Mostrar teclado",
      pianorollShowBackground: "Mostrar fundo",
      pianorollVoiceColorEnabled: "Cor de voz",
      voiceColorLegendEnabled: "Mostrar legenda",
      voiceColorLegendPosition: "Posição da legenda",
      voiceColorLegendXPercent: "X da legenda (%)",
      ...
      currentNoteInfoPosition: "Posição de exibição",
      currentNoteInfoXPercent: "X de exibição (%)",
      currentNoteInfoYPercent: "Y de exibição (%)",
      currentNoteInfoScale: "Tamanho",
      voiceColorLegendPosition_topLeft: "Superior esquerda",
      voiceColorLegendPosition_topRight: "Superior direita",
      voiceColorLegendPosition_bottomLeft: "Inferior esquerda",
      voiceColorLegendPosition_bottomRight: "Inferior direita",
      voiceColorDefault: "Padrão",
      waveformSection: "Efeito de Forma de Onda",
      waveformEnable: "Ativar forma de onda",
      waveformType: "Tipo de forma de onda",
      waveformType_oscilloscope: "Osciloscópio",
      waveformType_oscilloscope_circular: "Osciloscópio (circular)",
      waveformType_fft_horizontal: "FFT (horizontal)",
      waveformType_fft_circular: "FFT (circular)",
      waveformType_fft_icon_horizontal: "Ícone (linha horizontal)",
      waveformType_fft_icon_vertical: "Ícone (coluna vertical)",
      waveformType_fft_icon_horizontal_mirror: "Ícone (espelho horizontal)",
      waveformType_fft_icon_vertical_mirror: "Ícone (espelho vertical)",
      waveformType_fft_icon_circular: "Ícone (circular)",
      waveformDrawMethod: "Método de desenho",
      waveformDrawMethod_polyline: "Polilinha",
      waveformDrawMethod_curve: "Curva",
      waveformDrawMethod_fill: "Preenchimento",
      waveformDrawMethod_dots: "Pontos",
      waveformFftShape: "Forma FFT",
      waveformFftShape_barBottom: "Barra (base fixa)",
      waveformFftShape_barCenter: "Barra (centro fixo)",
      waveformFftShape_gauge: "Medidor",
      waveformFftShape_circle: "Círculo",
      waveformFftShape_circleFill: "Círculo (preenchido)",
      waveformFftShape_polyline: "Polilinha",
      waveformFftShape_curve: "Curva",
      waveformFftShape_fill: "Preenchimento",
      waveformFftGaugeShape: "Forma do medidor",
      waveformFftGaugeShape_bar: "Barra",
      waveformFftGaugeShape_square: "Quadrado",
      waveformFftGaugeShape_circle: "Círculo",
      waveformFftIconShape: "Forma do ícone",
      waveformFftIconShape_circle: "Círculo",
      waveformFftIconShape_square: "Quadrado",
      waveformFftIconShape_diamond: "Losango",
      waveformFftIconShape_triangle: "Triângulo",
      waveformFftIconShape_star: "Estrela",
      waveformFftIconShape_heart: "Coração",
      waveformFftIconShape_teardrop: "Gota",
      waveformFftIconStrengthMode: "Modo de força",
      waveformFftIconStrengthMode_glow: "Brilho",
      waveformFftIconStrengthMode_lightness: "Luminosidade",
      waveformFftIconStrengthMode_saturation: "Saturação",
      ...
      waveformFftIconEmitStrength: "Intensidade de emissão",
      waveformColor: "Cor",
      waveformColorMode: "Modo de cor",
      waveformColorMode_solid: "Sólido",
      waveformColorMode_lightness: "Gradiente de luminosidade",
      waveformColorMode_saturation: "Gradiente de saturação",
      waveformColorMode_hueVertical: "Gradiente de matiz vertical",
      waveformColorMode_hueHorizontal: "Gradiente de matiz horizontal",
      waveformOpacity: "Opacidade",
      waveformStrokeWidth: "Espessura da linha",
      waveformX: "Posição X",
      waveformY: "Posição Y",
      waveformRotation: "Rotação",
      waveformWidth: "Largura",
      waveformHeight: "Altura",
    ...
    mixMaster: {
      ...
      description:
        "Após gerar o vocal, ajuste os parâmetros, faça pré-escuta e aplique. As configurações são salvas por projeto.",
      vocal: "Vocal",
      vocalHighPass: "Filtro passa-altas",
      ...
      vocalNormalize: "Normalizar",
      vocalNormalizeTarget: "Nível-alvo",
      vocalEqBoost: "Realce de EQ",
      vocalEqBoostFreq: "Frequência central",
      vocalEqBoostGain: "Ganho",
      vocalReverb: "Reverb",
      vocalReverbWet: "Mistura",
      vocalReverbDecay: "Decaimento",
      background: "Acompanhamento",
      backgroundNormalize: "Normalizar",
      backgroundNormalizeTarget: "Nível alvo",
      backgroundEqCut: "Corte de EQ",
      backgroundEqCutFreq: "Frequência de corte",
      ...
      preview: "Pré-escuta",
      previewHint:
        'A prévia está sendo preparada. Se necessário, pressione "Atualizar prévia".',
      previewButton: "Atualizar prévia",
      reset: "Redefinir",
      resetAll: "Redefinir tudo",
      applyButton: "Aplicar configurações",
    },
