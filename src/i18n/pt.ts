export const translationPt = {
  ...
  videoEditor: {
    ...
    loadUstRequired: "Carregar UST (obrigatorio)",
    loadWavRequired: "Carregar WAV (obrigatorio)",
    loadPortraitOptional: "Carregar retrato (opcional)",
    loadIconOptional: "Carregar icone (opcional)",
    ...
    back: "Voltar",
    progressFrames: "{{current}}/{{total}} quadros",
