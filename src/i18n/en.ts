export const translationEn = {
  ...
  top: {
    ...
    campaigns: [
      ...
      {
        title: "UTAU Super Upload Festival 2026 Spring",
        about: "Join Niconico Chokaigi and post your UTAU videos!",
        startDatetime: "Apr 18, 2026",
        endDatetime: "Apr 25, 2026",
        eventTag: "UTAU超投稿祭2026春",
        regulations: [
          "Original songs, covers, HANASU, MMD... any UTAU video is welcome!",
          "NicoNico Shorts are also welcome.",
          "Post on NicoNico only.",
          "Collaborations with other synthesis software are OK!",
          "Follow each voicebank library's terms of use.",
        ],
      },
    ],
    linkTitle: "Links",
    ...
    linkVideoEditor: "Open Video Editor",
    invalidFile:
      "The selected file is not a zip file. Please select a zip file.",
  },
  videoEditor: {
    headerTitle: "UTAlet Video Editor",
    headerBackToMain: "Back to UTAlet",
    linkPaperTitle: "Page links",
    linkPaperMutual: "Mutual links",
    linkBackToMain: "Back to UTAlet",
    ...
    topDescription:
      "Video editing starts with required UST input. After loading UST and then WAV, the editor view becomes available.",
    loadUstRequired: "Load UST",
    loadWavRequired: "Load WAV",
    loadPortraitOptional: "Load Portrait",
    loadIconOptional: "Load Icon",
    ustStatusLoaded: "UST: {{name}}",
    ustStatusEmpty: "UST: Not loaded",
    wavStatusLoaded: "WAV: {{name}}",
    wavStatusEmpty: "WAV: Not loaded",
    portraitStatusLoaded: "Portrait: {{name}}",
    portraitStatusEmpty: "Portrait: Not loaded (Optional)",
    iconStatusLoaded: "Icon: {{name}}",
    iconStatusEmpty: "Icon: Not loaded (Optional)",
    iconLoadTitle: "Pianoroll Icon",
    portraitLoadTitle: "Portrait Asset",
    syncAdjustTitle: "Sync Adjustment (WAV/UST Offset)",
    wavOffsetMs: "WAV Offset (ms)",
    ustOffsetMs: "UST Offset (ms)",
    resetOffsets: "Reset Offsets",
    playFirstLyricSegment: "Play First Lyric Segment",
    stopPreview: "Stop Preview",
    previewRangeMs: "Preview range: {{start}}ms - {{end}}ms",
    previewNoLyrics: "No first lyric segment found.",
    previewPlayError: "Failed to play preview: {{error}}",
    clearOptional: "Clear Asset",
    openEditor: "Open Video Editor",
    backToMaterials: "Back to Material Selection",
    exporting: "Generating video...",
    back: "Back",
  ...
  infoVBDialog: {
    ...
    diagnostics: {
      ...
      description:
        "Check voice bank integrity. Click the button to start diagnostics.",
      errorSection: "Errors",
      warningSection: "Warnings",
      types: {
        wav_without_oto: "WAV file without oto record",
        missing_frq: "FRQ file not found",
  ...
  editor: {
    ...
    videoExport: {
      ...
      backgroundStyleSection: "Background style",
      backgroundStyle: "Pattern",
      backgroundPrimaryColor: "Primary color",
      backgroundSecondaryColor: "Secondary color",
      backgroundSecondaryOpacity: "Secondary opacity",
      backgroundPatternSize: "Pattern size",
      backgroundPatternGap: "Gap",
      backgroundPatternRotation: "Rotation",
      backgroundNoiseIntensity: "Noise intensity",
      backgroundSeed: "Seed",
      backgroundGradientSection: "Gradient",
      backgroundGradientEnable: "Gradient",
      backgroundGradientType: "Type",
      backgroundGradientType_lightness: "Lightness",
      backgroundGradientType_saturation: "Saturation",
      backgroundGradientType_alpha: "Opacity",
      backgroundGradientAngle: "Angle",
      backgroundGradientStart: "Start",
      backgroundGradientEnd: "End",
      backgroundGradientStrength: "Strength",
      backgroundMove: "Move",
      ...
      backgroundStyle_dots: "Dots",
      backgroundStyle_stars: "Stars",
      backgroundStyle_gingham: "Gingham",
      backgroundStyle_grid: "Grid",
      backgroundStyle_stripes: "Stripes",
      backgroundStyle_diagonalStripes: "Diagonal stripes",
      backgroundStyle_checkerboard: "Checkerboard",
      backgroundStyle_diamonds: "Diamonds",
      backgroundStyle_crosses: "Crosses",
      backgroundStyle_brickwork: "Brickwork",
      backgroundStyle_zigzag: "Zigzag",
      backgroundStyle_circles: "Circles",
      backgroundStyle_triangles: "Triangles",
      backgroundStyle_waves: "Waves",
      backgroundStyle_starfield: "Starfield",
      backgroundStyle_clouds: "Clouds",
      backgroundStyle_woodgrain: "Woodgrain",
      backgroundStyle_paper: "Paper",
      backgroundStyle_concrete: "Concrete",
      backgroundStyle_stucco: "Stucco",
      backgroundStyle_fabric: "Fabric",
      backgroundStyle_leather: "Leather",
      bgSize: "Resolution",
      ...
      mainTextSection: "Title",
      subTextSection: "Credits",
      textFontSize: "Font size",
      textPositionX: "X position",
      textPositionY: "Y position",
      textDisplayMode: "Display timing",
      textDisplayModeAlways: "Always",
      textDisplayModeIntro: "Intro",
      textDisplayModeOutro: "Outro",
      ...
      textBgBar: "Background bar",
      textBgBarColor: "Bar color",
      textBgBarOpacity: "Bar opacity",
      textColor: "Text color",
      mainTextDefault: "Song title",
      subTextDefault: "Composer / Voice bank / UST creator",
      exportPreview: "Export preview",
      lyricsSection: "Subtitles",
      lyricsEnable: "Enable subtitles",
      lyricsGlobalSettings: "Display settings",
      lyricsFontSize: "Font size",
      lyricsColor: "Text color",
      lyricsPositionY: "Vertical position",
      lyricsMaxWidth: "Max width (auto-shrink)",
      lyricsStart: "Start",
      lyricsEnd: "End",
      lyricsMerge: "Merge with next",
      lyricsSplit: "Split",
      lyricsSplitAt: "Split here",
      lyricsDecoration: "Text Decoration",
      lyricsShadow: "Shadow",
      lyricsShadowColor: "Shadow color",
      lyricsShadowBlur: "Shadow blur",
      lyricsStroke: "Stroke",
      lyricsStrokeColor: "Stroke color",
      lyricsStrokeWidth: "Stroke width",
      ...
      lyricsCardMappingHint:
        "Left: lyrics card  /  Right: lyric motion segment  —  split or merge segments to align them",
      lyricsCardWordColumn: "Lyrics card",
      lyricsCardSegmentColumn: "Segment",
      lyricsCardOpsColumn: "Ops",
      lyricsCardOrphan: "(no match)",
      lyricsCardUnassigned: "Unassigned words:",
      lyricsCardApply: "Apply",
      lyricsCardCancel: "Cancel",
      lyricsCardEncodingConfirm: "Confirm",
      lyricsCardEncodingCancel: "Cancel",
      pianorollSection: "Pianoroll",
      pianorollEnable: "Include pianoroll in video",
      pianorollLayout: "Layout",
      pianorollHorizontalZoom: "Horizontal zoom",
      pianorollVerticalZoom: "Vertical zoom",
      pianorollFps: "Update FPS",
      ...
      pianorollShowKeyboard: "Show keyboard",
      pianorollShowBackground: "Show background",
      pianorollVoiceColorEnabled: "Voice color",
      voiceColorLegendEnabled: "Show legend",
      voiceColorLegendPosition: "Legend position",
      voiceColorLegendXPercent: "Legend X (%)",
      ...
      currentNoteInfoPosition: "Position",
      currentNoteInfoXPercent: "X (%)",
      currentNoteInfoYPercent: "Y (%)",
      currentNoteInfoScale: "Size",
      voiceColorLegendPosition_topLeft: "Top left",
      voiceColorLegendPosition_topRight: "Top right",
      voiceColorLegendPosition_bottomLeft: "Bottom left",
      voiceColorLegendPosition_bottomRight: "Bottom right",
      voiceColorDefault: "Default",
      waveformSection: "Waveform Effect",
      waveformEnable: "Enable waveform",
      waveformType: "Waveform type",
      waveformType_oscilloscope: "Oscilloscope",
      waveformType_oscilloscope_circular: "Oscilloscope (circular)",
      waveformType_fft_horizontal: "FFT (horizontal)",
      waveformType_fft_circular: "FFT (circular)",
      waveformType_fft_icon_horizontal: "Icon (horizontal row)",
      waveformType_fft_icon_vertical: "Icon (vertical column)",
      waveformType_fft_icon_horizontal_mirror: "Icon (horizontal mirror)",
      waveformType_fft_icon_vertical_mirror: "Icon (vertical mirror)",
      waveformType_fft_icon_circular: "Icon (circular)",
      waveformDrawMethod: "Draw method",
      waveformDrawMethod_polyline: "Polyline",
      waveformDrawMethod_curve: "Curve",
      waveformDrawMethod_fill: "Fill",
      waveformDrawMethod_dots: "Dots",
      waveformFftShape: "FFT shape",
      waveformFftShape_barBottom: "Bar (bottom anchored)",
      waveformFftShape_barCenter: "Bar (center anchored)",
      waveformFftShape_gauge: "Gauge",
      waveformFftShape_circle: "Circle",
      waveformFftShape_circleFill: "Circle (filled)",
      waveformFftShape_polyline: "Polyline",
      waveformFftShape_curve: "Curve",
      waveformFftShape_fill: "Fill",
      waveformFftGaugeShape: "Gauge shape",
      waveformFftGaugeShape_bar: "Bar",
      waveformFftGaugeShape_square: "Square",
      waveformFftGaugeShape_circle: "Circle",
      waveformFftIconShape: "Icon shape",
      waveformFftIconShape_circle: "Circle",
      waveformFftIconShape_square: "Square",
      waveformFftIconShape_diamond: "Diamond",
      waveformFftIconShape_triangle: "Triangle",
      waveformFftIconShape_star: "Star",
      waveformFftIconShape_heart: "Heart",
      waveformFftIconShape_teardrop: "Teardrop",
      waveformFftIconStrengthMode: "Strength mode",
      waveformFftIconStrengthMode_glow: "Glow",
      waveformFftIconStrengthMode_lightness: "Lightness",
      waveformFftIconStrengthMode_saturation: "Saturation",
      waveformFftIconStrengthMode_hue_by_power: "Hue by power",
      ...
      waveformColorMode_lightness: "Lightness gradient",
      waveformColorMode_saturation: "Saturation gradient",
      waveformColorMode_hueVertical: "Vertical hue gradient",
      waveformColorMode_hueHorizontal: "Horizontal hue gradient",
    ...
    mixMaster: {
      title: "Simple Mix/Master",
      description:
        "After vocal rendering, adjust settings, preview, and then apply. Settings are saved per project.",
      vocal: "Vocal",
      vocalHighPass: "High-pass filter",
      ...
      vocalNormalize: "Normalize",
      vocalNormalizeTarget: "Target level",
      vocalEqBoost: "EQ boost",
      vocalEqBoostFreq: "Center frequency",
      vocalEqBoostGain: "Gain",
      vocalReverb: "Reverb",
      vocalReverbWet: "Wet mix",
      vocalReverbDecay: "Decay",
      background: "Background",
      backgroundNormalize: "Normalize",
      backgroundNormalizeTarget: "Target level",
      backgroundEqCut: "EQ cut",
      backgroundEqCutFreq: "Cut frequency",
      ...
      preview: "Preview",
      previewHint:
        'Preview is being prepared. Press "Update Preview" if needed.',
  ...
  batchprocess: {
    ...
    pitchHumanizeBatchProcess: "Randomize Pitch",
