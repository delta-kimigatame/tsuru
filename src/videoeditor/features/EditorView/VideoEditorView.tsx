      ...
      case "pianoroll":
        return notes && notes.length > 0 ? (
          <PianorollSection
            ...
            onFpsChange={form.setPianorollFps}
        ...
        return (
          <>
            <FormControl size="small" fullWidth sx={{ mb: 2 }}>
              <InputLabel id="video-editor-text-display-mode-label">
                {t("editor.videoExport.textDisplayMode")}
              </InputLabel>
              <Select
                labelId="video-editor-text-display-mode-label"
            ...
            <Box sx={{ mt: 2 }}>
              <LyricsSubtitleSection
                ...
                onSlideInOutDurationMsChange={
                  form.setLyricsSlideInOutDurationMs
                }
