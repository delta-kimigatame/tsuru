...
import {
  notesUp,
  NotesUpButton,
} from "../../../../src/features/EditorView/NoteMenu/NotesUpButton";
import { Note } from "../../../../src/lib/Note";
import { undoManager } from "../../../../src/lib/UndoManager";
import { Ust } from "../../../../src/lib/Ust";
import { useMusicProjectStore } from "../../../../src/store/musicProjectStore";

describe("NotesUpButton", () => {
  ...
  it("notesUp:渡したノートが半音上がる", () => {
    const notes = createNotes();
    const resultNotes = notesUp(notes);
  ...
  it("ボタンをクリックすると、選択されたノートが半音上がる", async () => {
    ...
    render(<NotesUpButton selectedNotesIndex={[0, 2, 4]} />);
    const button = await screen.findByTestId("NotesUpButton");
