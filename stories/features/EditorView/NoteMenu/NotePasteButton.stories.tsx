...
const meta: Meta<typeof NotePasteButton> = {
  title: "features/EditorView/NoteMenu/NotePasteButton",
  component: NotePasteButton,
  tags: ["autodocs"],
};
  ...
  decorators: [
    (Story) => {
      const [selectedNotesIndex, setSelectedNotesIndex] = React.useState<
        number[]
      >([2]);
      const [pasteTargetNote, setPasteTargetNote] = React.useState<
        number[] | undefined
      >(undefined);
