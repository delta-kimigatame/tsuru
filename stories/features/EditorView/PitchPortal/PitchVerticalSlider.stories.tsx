...
const meta: Meta<typeof PitchVerticalSlider> = {
  title: "features/EditorView/PitchPortal/PitchVerticalSlider",
  component: PitchVerticalSlider,
  tags: ["autodocs"],
};
